...
8. الباقات:
   - باقة الصانع (475 ج/شهر): فرع واحد، موظف واحد، خزينة واحدة
   - باقة المركز (700 ج/شهر): فرعين، 4 موظفين، خزينتين + سوق B2B + AI
   - باقة الشبكة (1400 ج/شهر): غير محدود + مزادات + Escrow + دعم أولوية
