...
8. الباقات:
   - باقة سيلفر (475 ج/شهر): لمراكز الصيانة وتجار قطع الغيار — فرع واحد، موظف واحد، خزينة واحدة
   - باقة جولد (700 ج/شهر): لمراكز الصيانة وتجار قطع الغيار الشامل — فرعين، 4 موظفين، خزينتين + سوق B2B + AI
   - باقة Empire (1400 ج/شهر): لتجار القطع والشركات الكبيرة — غير محدود + مزادات + Escrow + دعم أولوية
