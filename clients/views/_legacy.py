...
# ───────────────────────────────────────────────────────────────────────────
# واحد endpoint مرن (GET/POST/DELETE) للـ brand profile + endpoint منفصل
# لحذف لوجو فقط.
# ═══════════════════════════════════════════════════════════════════════════
@csrf_exempt
def brand_profile_view(request):
    ...
    if request.method == 'POST':
        # 🛡️ Rate limit — 10 updates per minute (saving brand profile shouldn't be spammy)
        ...
        # 🛡️ Hex color validation
        import re as _re_hex
        hex_re = _re_hex.compile(r'^#[0-9A-Fa-f]{3,8}$')
