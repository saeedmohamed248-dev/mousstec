...
CELERY_TASK_ROUTES = {
    ...
    # على default عشان الاستجابة الفورية لضغطات المستخدم (مش وراء مهام AI تقيلة).
    'social_ads.autopost_from_inventory':               {'queue': 'default'},
    'social_ads.generate_ideas':                        {'queue': 'default'},
    'social_ads.attribute_all_sales':                   {'queue': 'default'},
    'social_ads.attribute_sales':                       {'queue': 'default'},
    'social_ads.run_ab_experiment':                     {'queue': 'default'},
...
CELERY_BEAT_SCHEDULE = {
    ...
    # ── Social Studio: attribute sales to posts BEFORE learning ────
