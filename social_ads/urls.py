...
urlpatterns = [
    ...
    path("social-studio/studio/assistant/", studio_views.assistant, name="social_ads_assistant"),
    path("social-studio/studio/assistant/chat/", studio_views.assistant_chat, name="social_ads_assistant_chat"),
