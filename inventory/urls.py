...
urlpatterns = [
    ...
    path('treasuries/<int:pk>/', views_lightning.treasury_detail, name='treasury_detail'),
    path('treasuries/<int:pk>/movement/', views_lightning.treasury_movement, name='treasury_movement'),
    path('treasuries/<int:pk>/transfer/', views_lightning.treasury_transfer, name='treasury_transfer'),
    path('transactions/', views_lightning.transactions_list, name='transactions_list'),
    path('transactions/<int:pk>/delete/', views_lightning.treasury_txn_delete, name='treasury_txn_delete'),
    path('customers/', views_lightning.customers_receivables, name='customers_receivables'),
    ...
    path('reports/', views_lightning.reports_hub, name='reports_hub'),
    path('reports/advisor/', views_lightning.business_advisor, name='business_advisor'),
    path('reports/advisor/ask/', views_lightning.business_advisor_ask, name='business_advisor_ask'),
    path('reports/sales/', views_lightning.sales_report, name='sales_report'),
